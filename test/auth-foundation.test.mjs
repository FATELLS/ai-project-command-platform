...
test("migrations apply after unchanged migration 001 and repeat safely", () => {
  ...
  try {
    assert.deepEqual(applied, ["001_initial.sql", "002_auth_project_access.sql", "003_module_registry_templates.sql", "004_materials_evidence.sql", "005_structured_change_proposals.sql"]);
