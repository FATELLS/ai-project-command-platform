...
import { createGenerationProviderFromEnv } from "../src/ai/provider-factory.mjs";

test("generation provider is disabled without a dedicated key",()=>{const provider=createGenerationProviderFromEnv({AI_GENERATION_PROVIDER:"openai-compatible"});assert.equal(provider.configured,false);});
